...
app.post("/About", async (req, res) => {
    ...
    const email = `${firstname.trim().toLowerCase()}.${lastname.trim().toLowerCase()}smsu.edu`;
...
app.post("/created", (req, res) => {
    ...
    if (!email.endsWith("smsu.edu")) {
        return res.status(400).send("Only smsu.edu emails are allowed.");
    }
    ...
    const mailOptions = {
        from: 'ab.bahiru@gmail.com',  // Replace with your email
